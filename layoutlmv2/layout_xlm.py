...
save_model_path = "/data/experiments/1data/savedmodel/xlm/"
...
class LayoutLMForTokenClassification(nn.Module):
    def __init__(self, output_size=(3, 3),
        ...
        self.layoutlm = LayoutLMv2ForTokenClassification.from_pretrained("microsoft/layoutxlm-base",
...
def saveLog(epoch,loss,f1_score,everyclass):
  result_dir = "/data/experiments/1data/result/xlm"
  train_log_filename = "layoutLM_xlm_train_log.txt"
