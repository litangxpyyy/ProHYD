...
save_model_path = "/data/experiments/1data/savedmodel/layoutlmv2/"
...
class FUNSDDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.train:
            ...
            base_path = "/home/litang/LtProject/newpreddata"
        else:
...
def train():
    ...
    for epoch in range(num_train_epochs):
        ...
        for batch in tqdm(train_dataloader, desc='T'):
...
def saveLog(epoch,loss,f1_score,everyclass):
  result_dir = "/data/experiments/1data/result/v2"
  train_log_filename = "layoutLMV2_large_train_log.txt"
