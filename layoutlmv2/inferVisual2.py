...
# config = Config()
from layout_v2 import FUNSDDataset,idx2label,model
...
model_path = "/data/experiments/1data/savedmodel/layoutlmv2/layoutlmv20.8857.pth.tar"
...
#保存图片的路径
save_image_path= "/home/litang/LtProject/haiyundan/v2nopro/saveimage"

 
jsonPath = "/home/zhangjunwei/Zjwproject/layoutgcn1/haiyundan/layoutlm_data/annotations1"
savePath = "/home/litang/LtProject/haiyundan/v2nopro/savejson"
...
def dealAllImage():
  ...
  for i in range(len(image_files)):
    ...
    inference_dataset = FUNSDDataset(image_file_names=image_file_name, max_length=512, target_size=224, train=False, predict = True)
    test_encoding = inference_dataset[0]
    test_encoding.keys()

    # 
    if image_files[i] == '507525.png':
      print("a") 
