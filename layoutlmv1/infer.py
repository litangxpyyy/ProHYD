...
config = Config()
from layout_v1 import FUNSDDataset,idx2label,tokenizer,model
...
#保存图片的路径
save_image_path= "/home/litang/LtProject/haiyundan/v2/saveimage"

#测试的json文件路径
jsonPath = "/home/zhangjunwei/Zjwproject/layoutgcn1/haiyundan/layoutlm_data/annotations1"
#保存的json文件路径
savePath = "/home/litang/LtProject/haiyundan/v2/savejson"
...
def dealAllImage():
  ...
  for i in range(len(image_files)):
    ...
    inference_dataset = FUNSDDataset(image_file_names=image_file_name, tokenizer=tokenizer, max_length=512, target_size=224, train=False)
