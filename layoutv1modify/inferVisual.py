...
import os
from layout_v1_modify import FUNSDDataset,idx2label,tokenizer,config,model1
model_path = "/home/zhangjunwei/Zjwproject/layoutgcn1/savemodel/haiyundan/litang/0.0047.pth.tar"
...
#保存图片的路径
save_image_path= "/home/litang/LtProject/haiyundan/v1modify/saveimage"

 
jsonPath = "/home/zhangjunwei/Zjwproject/layoutgcn1/haiyundan/layoutlm_data/annotations1"
savePath = "/home/litang/LtProject/haiyundan/v1modify/savejson"
...
def dealOneImage(test_encoding,image_name):
  ...
  _,outputs = model1(input_ids=input_ids, bbox=bbox, attention_mask=attention_mask, token_type_ids=token_type_ids, 
                labels=labels, resized_images=resized_images,
                 resized_and_aligned_bounding_boxes=resized_and_aligned_bounding_boxes,
                 trainer=False
          
                )
  token_predictions = outputs.squeeze().tolist() # the predictions are at the token level
  ...
  fontpath = "/home/zhangjunwei/Zjwproject/layoutgcn1/Contrast experiment/font/MSYHL.TTC"
  textsize=15
